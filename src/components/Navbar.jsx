        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900">Sistema Inteligente Parqueadero</h1>
                <p className="text-xs text-slate-500">Detección Automática de Placas</p>
              </div>
            </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to="/registros" className="flex items-center space-x-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition-colors">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
